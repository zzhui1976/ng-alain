...
import { LegalCustomerOrderEditComponent } from './legal-customer-order-edit.component';

@Component({
  selector: 'app-sale004-legal-customer-order',
  standalone: true,
...
export class LegalCustomerOrderComponent {
  ...
  url = '/sale004/legal-customer-order/query';
  columns: STColumn[] = [
      ...
      buttons: [
        {
          ...
          type: 'modal',
          modal: {
            component: LegalCustomerOrderEditComponent,
            paramsName: 'i'
          },
  ...
  add(): void {
    this.modal.createStatic(LegalCustomerOrderEditComponent, { i: { id: 0, items: [], payments: [] } }).subscribe(() => {
      this.st.load();
