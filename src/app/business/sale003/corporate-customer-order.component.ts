...
import { CorporateCustomerOrderEditComponent } from './corporate-customer-order-edit.component';
import { EnumService } from './enum.service';

@Component({
  selector: 'app-sale003-corporate-customer-order',
  standalone: true,
...
export class CorporateCustomerOrderComponent {
  ...
  url = '/sale003/corporate-customer-order/query';
  columns: STColumn[] = [
      ...
      buttons: [
        {
          ...
          type: 'modal',
          modal: {
            component: CorporateCustomerOrderEditComponent,
            paramsName: 'i'
          },
  ...
  add(): void {
    this.modal.createStatic(CorporateCustomerOrderEditComponent, { i: { id: 0, items: [], payments: [] } }).subscribe(() => {
      this.st.load();
